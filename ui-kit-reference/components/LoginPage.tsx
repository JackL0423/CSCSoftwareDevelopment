...
import { ChefHat, Mail, Lock, AlertCircle, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-bold mb-3 text-on-surface">Welcome Back</h1>
          <p className="text-on-surface-variant">Log in to continue your culinary adventure</p>
        </div>
        ...
        <div className="bg-surface-container-low rounded-[28px] shadow-lg p-8 border border-outline-variant">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button 
              type="submit" 
              className="w-full h-14 bg-primary text-on-primary hover:bg-primary/90 shadow-md rounded-full mt-8"
              disabled={isLoading}
            >
