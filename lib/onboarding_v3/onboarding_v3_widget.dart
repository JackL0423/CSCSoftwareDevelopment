...
/// Onboarding Page 3/5 — Region Setup
///
/// Build onb_region.
///
/// Goal: set country & city (for localized recipes).
///
/// UI: title “Where are you cooking?”. Fields: Country (searchable dropdown),
/// City (autocomplete text). Button Use Current Location (requests location;
/// reverse-geocode → country/city; store geo: {lat,lng}).
///
/// Actions:
///
/// Continue → upsert users/{uid}.profile: {country, city, geo?}; set
/// onboarding.region=true; navigate /onb_notify.
///
/// Skip → set onboarding.regionSkipped=true; navigate next.
///
/// Handle permission denied → show “Open Settings” link.
///
