...
import '/components/add_new_tag_pref_widget.dart';
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().userTags = (currentUserDocument?.prefTags.toList() ?? [])
          .toList()
          .cast<String>();
      FFAppState().dietaryTags = (currentUserDocument?.dietTags.toList() ?? [])
          .toList()
          .cast<String>();
      safeSetState(() {});
    });
